...
<div class="w3-container">
      <h5> <button class="w3-button w3-block w3-teal" onclick="document.getElementById('Add Student Attendance').style.display='block'">Add Student Attendance</button></h5>
...
<div id="Add Student Attendance" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom">
    ...
    <div class="w3-container">
      ...
      <form action="attendants.php" target="_blank" METHOD="POST">

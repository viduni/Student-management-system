...
<?php
    ...
    $s="INSERT INTO student_GPA_CIS_3(reg,ep,c1,g1,c2,g2,c3,g3,c4,g4,c5,g5,c6,g6)
...
$res=mysqli_query($conn, "select * from student_GPA_CIS_3");
...
$sql = "SELECT * FROM student_GPA_CIS_3";
